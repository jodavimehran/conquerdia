...
public class ConquerdiaModel {
	...
	public String populateCountries() {
		...
		return String.format("All %d countries are populated and each of %d players are allocated %d initial armies.",
				numberOfCountries, numberOfPlayers, numberOfInitialArmies);
	}
